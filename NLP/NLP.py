...
wordcloud_positive = WordCloud(font_path='SimHei.ttf', background_color='white', max_words=100).generate(positive_comments)
...
plt.figure(figsize=(10, 5))
wordcloud_negative = WordCloud(font_path='SimHei.ttf', background_color='white', max_words=100, colormap='Reds').generate(negative_comments)
